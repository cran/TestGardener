...
make_dataList <- function(chcemat, scoreList, noption, sumscr_rng=NULL, 
  ...
  SfdList <- Sbinsmth.init(percntrnk, nbin, SfdPar, grbgvec, noption, chcemat) 
...
Sbinsmth.init <- function(percntrnk, nbin, SfdPar, grbgvec, noption, chcemat) {
